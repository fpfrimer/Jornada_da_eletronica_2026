...
Quantidade de participantes & Não registrada no material disponível. \\
\end{tabularx}
}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth,angle=270]{figuras/20260422_185032.jpg}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth,angle=270]{figuras/20260422_193645.jpg}
        \caption{Acompanhamento dos participantes durante a atividade.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
...
A lista de participantes não foi localizada entre os arquivos disponibilizados para a elaboração deste relatório. Recomenda-se anexá-la posteriormente, caso esteja disponível em formulário, plataforma de inscrição ou lista de presença física.
